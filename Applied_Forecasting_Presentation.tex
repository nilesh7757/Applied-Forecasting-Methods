...
\begin{columns}
    ...
    \begin{column}{0.45\textwidth}
        ...
        \begin{itemize}
            \item \textbf{EDA vs Stress:} Strong positive correlation (0.95). Increased skin conductance directly maps to stress arousal.
            \item \textbf{TEMP vs Stress:} Inverse correlation (-0.53). Peripheral skin temperature typically drops during acute stress.
        \end{itemize}
    \end{column}
\end{columns}
\end{frame}
