...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{EDA_Graphs/03_S2_Proper_Correlation.png}
    \caption{Full Pearson Correlation Matrix (Physiology vs. Stress)}
    \label{fig:corr}
\end{figure}
\textbf{Interpretation}: 
\begin{itemize}
    \item \textbf{EDA vs. Stress (r=0.95)}: Confirms that skin conductance is the primary predictor of stress arousal in this pipeline. The near-perfect correlation highlights the high fidelity of the engineered continuous proxy.
    \item \textbf{Temp vs. Stress (r=-0.53)}: The negative correlation visually proves vasoconstriction---the biological cooling of skin during stress.
    \item \textbf{Heart Rate vs. Stress (r=0.49)}: Shows a significant positive relationship, indicating cardiovascular arousal increases with stress intensity.
\end{itemize}
